...
function getFootnoteHtml(element: Element): [number, string, string] | null {
    ...
    return [index, href, referencedEl.innerHTML]
}
...
export function runFootnotes() {
    ...
    footnotes.forEach(f => {
        const [index, href, htmlContent] = getFootnoteHtml(f) ?? [
            null,
            null,
            null
        ]
        if (index == null || href == null || htmlContent == null) return
